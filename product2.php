...
<head>
  ...
  <meta name="description" content="Brew & Go Coffee - Artisan Brew">
  <meta name="keywords" content="Coffee, Artisan Brew, Brew & Go, Espresso">
  <meta name="author" content="TERENCE WONG, DARREN CHONG, HANS YEE">
  <title>Brew & Go - Artisan Brew</title>
      ...
      <div class="prd-product-list">
        <?php if (mysqli_num_rows($result) > 0): ?>
          <?php while ($row = mysqli_fetch_assoc($result)): ?>
            ...
            // Sanitize product name for use as an ID: lowercase, replace spaces with hyphens
            $product_id = strtolower(str_replace(' ', '-', htmlspecialchars($row['name'])));
            ?>
    ...
    <div id="artisan-brew">
      <div class="prd-product-list">
        <?php if (mysqli_num_rows($result) > 0): ?>
          ...
          <?php endwhile; ?>
        <?php else: ?>
          <p>No products available in Artisan Brew.</p>
        <?php endif; ?>
      </div>
    </div>
  </div>
